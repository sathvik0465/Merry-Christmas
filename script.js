...
/* PAGE 5 – TYPING EFFECT */
function typeText() {
  const msg = `I just wanted to tell you something…
You really are special in a way that’s hard to explain.
I just wanted to tell you something… i made some small tiny mistakes, First, about the permission letter — I told you I’d write it for the HOD, but I didn’t end up giving it.  I’m sorry for doing that.
...
And lastly, I know this letter itself is coming late, this will not happen again it's my pinky promise`;
